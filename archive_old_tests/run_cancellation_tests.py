#!/usr/bin/env python3
"""
Test runner that executes each cancellation test in a separate subprocess
...
from test_cancellation import {test_name}
...
def main():
    """Run all cancellation tests in separate subprocesses"""
    print("\n=== Starting Cancellation Tests with Process Isolation ===\n")
    
    tests = [
        "test_cancel_active_task",
